...
class Juno_Facebook_Block_Adminhtml_Newsletter_Subscriber_Grid extends Mage_Adminhtml_Block_Newsletter_Subscriber_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('type', array(
            ...
            'options'   => array(
                ...
                3  => Mage::helper('facebook')->__('Facebook')
            )
        ));
